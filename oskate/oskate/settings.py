# Django settings for oskate project.
# -*- coding: utf-8 -*-
import os
gettext = lambda s: s
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_PATH, 'addstatic'),
)
...
SECRET_KEY = 'n9yhbt)1^gf+t+64&c@qgc13mw9i9zk)iil@%&h2vy0^=50v$_'
...
ROOT_URLCONF = 'oskate.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'oskate.wsgi.application'
